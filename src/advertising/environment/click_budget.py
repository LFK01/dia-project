...
def clicks(budget, max_value, coefficient, d, e):
    return max_value * (1.0 - np.exp(-coefficient * budget + 7 / 2 * budget ** 2 + 3 * budget ** 3 - 3 * budget ** 4))
...
# ClickBudget class
class ClickBudget:
    def __init__(self, budget_id, budgets, sigma, max_value=100, coefficient=4, d=3, e=2):
        self.budgets = budgets
        self.means = clicks(budgets, max_value, coefficient, d, e)
