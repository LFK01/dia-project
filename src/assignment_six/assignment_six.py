...
for e in tqdm(range(0, n_experiments), desc="Experiment processed", unit="exp"):
    ...
    for s in subcampaigns:
        ...
        greedy_learners_pricing.append(GreedyLearner(n_arms=n_arms_pricing))
    ...
    for t in range(0, T):
        ...
        for s in subcampaigns:
            ...
            total_clicks += reward_advertising
    ...
    gp_rewards_per_experiment_advertising.append(total_clicks_per_t)
